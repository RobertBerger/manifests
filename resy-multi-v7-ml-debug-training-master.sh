...
#MYMAP[meta-osselot-master]="${GITHUB}/iris-GmbH/meta-osselot ${SOURCES}/meta-osselot-master master"
# my resy distro 
...
MYMAP[meta-openembedded-master]="${GIT_OE}/meta-openembedded ${SOURCES}/meta-openembedded-master master ${SOURCES}/manifests/meta-openembedded-master/patch.sh 01dd622533957d20fa860e34ff098161a103bfbf"
...
MYMAP[use-libpalindrome-cpp]="${GITLAB}/exempli-gratia/use-libpalindrome-cpp ${TRAINING_SOURCES}/use-libpalindrome-cpp master"
MYMAP[boost-filesystem-cmake]="${GITLAB}/exempli-gratia/boost-filesystem-cmake ${TRAINING_SOURCES}/boost-filesystem-cmake master"
MYMAP[libhw-autotooled-so-a]="${GITLAB}/exempli-gratia/libhw-autotooled-so-a ${TRAINING_SOURCES}/libhw-autotooled-so-a master"
MYMAP[libhw-autotooled-so]="${GITLAB}/exempli-gratia/libhw-autotooled-so ${TRAINING_SOURCES}/libhw-autotooled-so master"
MYMAP[lib-makefile-so]="${GITLAB}/exempli-gratia/lib-makefile-so ${TRAINING_SOURCES}/lib-makefile-so master"
MYMAP[simple-hello-world]="${GITLAB}/exempli-gratia/simple-hello-world ${TRAINING_SOURCES}/simple-hello-world master"
MYMAP[use-makefile-lib-so]="${GITLAB}/exempli-gratia/use-makefile-lib-so ${TRAINING_SOURCES}/use-makefile-lib-so master"
MYMAP[golangexample]="${GITHUB}/RobertBerger/golangexample ${TRAINING_SOURCES}/golangexample master"
MYMAP[eclipse-cmake]="${GITLAB}/exempli-gratia/eclipse-cmake ${TRAINING_SOURCES}/eclipse-cmake master"
MYMAP[libhw-autotooled-a]="${GITLAB}/exempli-gratia/libhw-autotooled-a ${TRAINING_SOURCES}/libhw-autotooled-a master"
MYMAP[libhw]="${GITLAB}/exempli-gratia/libhw ${TRAINING_SOURCES}/libhw master"
MYMAP[hello-cpp]="${GITLAB}/exempli-gratia/hello-cpp ${TRAINING_SOURCES}/hello-cpp master"
MYMAP[js-npm-hello-world]="${GITHUB}/RobertBerger/js-npm-hello-world ${TRAINING_SOURCES}/js-npm-hello-world master"
MYMAP[hello-mod]="${GITLAB}/exempli-gratia/hello-mod ${TRAINING_SOURCES}/hello-mod master"
MYMAP[simple-hello-world-git]="${GITLAB}/exempli-gratia/simple-hello-world-git ${TRAINING_SOURCES}/simple-hello-world-git master"
MYMAP[libhwtest-cmake-so-a]="${GITLAB}/exempli-gratia/libhwtest-cmake-so-a ${TRAINING_SOURCES}/libhwtest-cmake-so-a master"
MYMAP[python-examples]="${GITHUB}/RobertBerger/python-examples ${TRAINING_SOURCES}/python-examples master"
MYMAP[simple-hello-world-logging]="${GITLAB}/exempli-gratia/simple-hello-world-logging ${TRAINING_SOURCES}/simple-hello-world-logging master"
MYMAP[simple-hello-world-logging-no-sstate-mirrors]="${GITLAB}/exempli-gratia/simple-hello-world-logging-no-sstate-mirrors ${TRAINING_SOURCES}/simple-hello-world-logging-no-sstate-mirrors master"
MYMAP[use-autotooled-lib]="${GITLAB}/exempli-gratia/use-autotooled-lib ${TRAINING_SOURCES}/use-autotooled-lib master"
MYMAP[helloworld-pthread-cmake]="${GITLAB}/exempli-gratia/helloworld-pthread-cmake ${TRAINING_SOURCES}/helloworld-pthread-cmake master"
MYMAP[hello-autotooled]="${GITLAB}/exempli-gratia/hello-autotooled ${TRAINING_SOURCES}/hello-autotooled 2.12"
MYMAP[libpalindrome-cpp-cmake-so-a]="${GITLAB}/exempli-gratia/libpalindrome-cpp-cmake-so-a ${TRAINING_SOURCES}/libpalindrome-cpp-cmake-so-a master"
MYMAP[simple-hello-world-logging-no-sstate-no-source-mirrors]="${GITLAB}/exempli-gratia/simple-hello-world-logging-no-sstate-no-source-mirrors ${TRAINING_SOURCES}/simple-hello-world-logging-no-sstate-no-source-mirrors master"
MYMAP[simple-hello-world-logging-nostamp]="${GITLAB}/exempli-gratia/simple-hello-world-logging-nostamp ${TRAINING_SOURCES}/simple-hello-world-logging-nostamp master"
MYMAP[helloworld-cmake]="${GITLAB}/exempli-gratia/helloworld-cmake ${TRAINING_SOURCES}/helloworld-cmake master"
MYMAP[libhw-cmake-a]="${GITLAB}/exempli-gratia/libhw-cmake-a ${TRAINING_SOURCES}/libhw-cmake-a master"
MYMAP[hello-makefile]="${GITLAB}/exempli-gratia/hello-makefile ${TRAINING_SOURCES}/hello-makefile master"
MYMAP[libhw-cmake-so]="${GITLAB}/exempli-gratia/libhw-cmake-so ${TRAINING_SOURCES}/libhw-cmake-so master"
MYMAP[sl]="${GITLAB}/exempli-gratia/sl ${TRAINING_SOURCES}/sl master"
MYMAP[my-rust-hello-world]="${GITLAB}/exempli-gratia/my-rust-hello-world ${TRAINING_SOURCES}/my-rust-hello-world main"
MYMAP[python-poetry-helloworld]="${GITHUB}/RobertBerger/python-poetry-helloworld ${TRAINING_SOURCES}/python-poetry-helloworld main"
# <-- training
...
# new:
#MYMAP[poky-container]="${GITHUB}/RobertBerger/poky-container ${CROPS_CONTAINER_X86_64}/poky-container 2024-03-11-master-local-icecc-ub22-doc-spdx"
# for training:
