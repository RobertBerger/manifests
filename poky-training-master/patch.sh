...
if ! patch -R -p1 -s -f --dry-run <${SCRIPTPATH}/against-769a4479e123a5c2951eab8915cbd2b29d82c7f9/0021-added-kernel-tooling-back-in-bsp-tooling-updated.patch; then
     patch -p1 <${SCRIPTPATH}/against-769a4479e123a5c2951eab8915cbd2b29d82c7f9/0021-added-kernel-tooling-back-in-bsp-tooling-updated.patch
fi

if ! patch -R -p1 -s -f --dry-run <${SCRIPTPATH}/against-769a4479e123a5c2951eab8915cbd2b29d82c7f9/0022-bsp-initial-walnascar-support.patch; then
     patch -p1 <${SCRIPTPATH}/against-769a4479e123a5c2951eab8915cbd2b29d82c7f9/0022-bsp-initial-walnascar-support.patch
fi

if ! patch -R -p1 -s -f --dry-run <${SCRIPTPATH}/against-769a4479e123a5c2951eab8915cbd2b29d82c7f9/0023-SERIAL_CONSOLES-switched-from-many-to-console.patch; then
     patch -p1 <${SCRIPTPATH}/against-769a4479e123a5c2951eab8915cbd2b29d82c7f9/0023-SERIAL_CONSOLES-switched-from-many-to-console.patch
fi
