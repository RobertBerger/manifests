...
if ! patch -R -p1 -s -f --dry-run <${SCRIPTPATH}/against-1bbdc674aef8abada28d130a23752c1d8a4620b9/0021-added-kernel-tooling-back-in-bsp-tooling-updated.patch; then
     patch -p1 <${SCRIPTPATH}/against-1bbdc674aef8abada28d130a23752c1d8a4620b9/0021-added-kernel-tooling-back-in-bsp-tooling-updated.patch
fi

if ! patch -R -p1 -s -f --dry-run <${SCRIPTPATH}/against-1bbdc674aef8abada28d130a23752c1d8a4620b9/0022-bsp-initial-nanbield-support.patch; then
     patch -p1 <${SCRIPTPATH}/against-1bbdc674aef8abada28d130a23752c1d8a4620b9/0022-bsp-initial-nanbield-support.patch
fi
